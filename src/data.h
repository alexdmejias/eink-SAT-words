...
const char *data[numArrays][elementsPerArray] = {
    ...
    {"abide", "(v.) to put up with", "Though he did not agree with the decision, Chuck decided to abide by it."},
    {"abide", "(v.) to remain", "Despite the beating they've taken from the weather throughout the millennia, the mountains abide."},
    ...
    {"abridge", "(adj.) shortened", "Moby-Dick is such a long book that even the abridged version is longer than most normal books."},
    ...
    {"acute", "(adj.) sharp, severe", "Arnold could not walk because the pain in his foot was so acute."},
    {"acute", "(adj.) having keen insight", "Because she was so acute, Libby instantly figured out how the magician pulled off his “magic.”"},
    ...
    {"adhere", "(n.) to stick to something", "We adhered the poster to the wall with tape."},
    {"adhere", "(n.) to follow devoutly", "He adhered to the dictates of his religion without question."},
    ...
    {"advocate", "(v.) to argue in favor of something", "Arnold advocated turning left at the stop sign, even though everyone else thought we should turn right."},
    {"advocate", "(n.) a person who argues in favor of something", "In addition to wanting to turn left at every stop sign, Arnold was also a great advocate of increasing national defense spending."},
    ...
    {"aggregate", "(n.) a whole or total", "The three branches of the U.S. Government form an aggregate much more powerful than its individual parts."},
    {"aggregate", "(v.) to gather into a mass", "The dictator tried to aggregate as many people into his army as he possibly could."},
    ...
    {"annex", "(v.) to incorporate territory or space", "After defeating them in battle, the Russians annexed Poland."},
    {"annex", "(n.) a room attached to a larger room or space", "He likes to do his studying in a little annex attached to the main reading room in the library."},
    ...
    {"apprehend", "(v.) to seize, arrest", "The criminal was apprehended at the scene."},
    {"apprehend", "(v.) to perceive, understand, grasp", "The student has trouble apprehending concepts in math and science."},
    ...
    {"asylum", "(n.) a place of refuge, protection, a sanctuary", "For Thoreau, the forest served as an asylum from the pressures of urban life."},
    {"asylum", "(n.) an institution in which the insane are kept", "Once diagnosed by a certified psychiatrist, the man was put in an asylum."},
    ...
    {"attribute", "(v.) to credit, assign", "He attributes all of his success to his mother's undying encouragement."},
    {"attribute", "(n.) a facet or trait", "Among the beetle's most peculiar attributes is its thorny protruding eyes."},
    ...
    {"bashful", "(adj.) shy, excessively timid", "Frankie's mother told him not to be bashful when he refus ed to attend the birthday party."},
    {"battery", "(n.) a device that supplies power", "Most cars run on a combination of power from a battery and gasoline."},
    {"battery", "(n.) assault, beating", "Her husband was accused of assault and battery after he attacked a man on the sidewalk."},
    ...
    {"bias", "(n.) a tendency, inclination, prejudice", "The judge's hidden bias against smokers led him to make an unfair decision."},
    ...
    {"blight", "(n.) a plague, disease", "The potato blight destroyed the harvest and bankrupted many families."},
    {"blight", "(n.) something that destroys hope", "His bad morale is a blight upon this entire operation."},
    ...
    {"buffet", "(v.) to strike with force", "The strong winds buffeted the ships, threatening to capsize them."},
    {"buffet", "(n.) an arrangement of food set out on a table", "Rather than sitting around a table, the guests took food from our buffet and ate standing up."},
    {"burnish", "(v.) to polish, shine", "His mother asked him to burnish the silverware before setting the table."},
    {"buttress", "(v.) to support, hold up", "The column buttresses the roof above the statue."},
    {"buttress", "(n.) something that offers support", "The buttress supports the roof above the statues."},
    ...
    {"canvas", "(n.) a piece of cloth on which an artist paints", "Picasso liked to work on canvas rather than on bare cement."},
    {"canvas", "(v.) to cover, inspect", "We canvassed the neighborhood looking for clues."},
    ...
    {"catalog", "(v.) to list, enter into a list", "The judge cataloged the victim's injuries before calculating how much money he would award."},
    {"catalog", "(n.) a list or collection", "We received a catalog from J. Crew that displayed all of their new items."},
    ...
    {"censure", "(n.) harsh criticism", "The frustrated teenager could not put up with anymore of her critical mother's censure."},
    {"censure", "(v.) to rebuke formally", "The principal censured the head of the English Department for forcing students to learn esoteric vocabulary."},
    ...
    {"chronicle", "(n.) a written history", "The library featured the newly updated chronicle of World War II."},
    {"chronicle", "(v.) to write a history", "Albert's diary chronicled the day-to-day growth of his obsession with Cynthia."},
    ...
    {"circumspect", "(adj.) cautious", "Though I promised Rachel's father I would bring her home promptly by midnight, it would have been more circumspect not to have specified a time."},
    ...
    {"clamor", "(n.) loud noise", "Each morning the birds outside my window make such a clamor that they wake me up."},
    {"clamor", "(v.) to loudly insist", "Neville's fans clamored for him to appear on stage, but he had passed out on the floor of his dressing room."},
    ...
    {"cleave", "(v.) to divide into parts", "Following the scandalous disgrace of their leader, the entire political party cleaved into warring factions."},
    {"cleave", "(v.) to stick together firmly", "After resolving their marital problems, Junior and Rosa cleaved to one another all the more tightly."},
    ...
    {"collateral", "(adj.) secondary", "Divorcing my wife had the collateral effect of making me poor, as she was the only one of us with a job or money."},
    ...
    {"compound", "(v.) to combine parts", "The difficulty of finding a fire escape amid the smoke was compounded with the dangers posed by the panicking crowds."},
    {"compound", "(n.) a combination of different parts", "My attraction to Donna was a compound of curiosity about the unknown, physical desire, and intellectual admiration."},
    {"compound", "(n.) a walled area containing a group of buildings", "When the fighting started, Joseph rushed into the family compound because it was safe and well defended."},
    ...
    {"convention", "(n.) an assembly of people", "The hotel was full because of the cattleranchers' convention."},
    {"convention", "(n.) a rule, custom", "The cattle-ranchers have a convention that you take off your boots before entering their houses."},
    ...
    {"coup", "(n.) a brilliant, unexpected act", "Alexander pulled off an amazing coup when he got a date with Cynthia by purposely getting hit by her car."},
    {"coup", "(n.) the overthrow of a government and assumption of authority", "In their coup attempt, the army officers stormed the Parliament and took all the legislators hostage."},
    {"covet", "(v.) to desire enviously", "I coveted Moses's house, wife, and car."},
    {"covert", "(adj.) secretly engaged in", "Nerwin waged a covertcampaign against his enemies, while outwardly appearing to remain friendly."},
    ...
    {"daunting", "(adj.) intimidating, causing one to lose courage", "He kept delaying the daunting act of asking for a promotion."},
    ...
    {"dialect", "(n.) a variation of a language", "In the country's remote, mountainous regions, the inhabitants spoke a dialect that the country's other inhabitants had difficulty understanding."},
    {"diaphanous", "(adj.) light, airy, transparent", "Sunlight poured in through the diaphanous curtains, brightening the room."},
    {"didactic", "(adj.) intended to instruct", "She wrote up a didactic document showing new employees how to handle the company's customers."},
    {"didactic", "(adj.) overly moralistic", "His didacticstyle of teaching made it seem like he wanted to persuade his students not to understand history fully, but to understand it from only one point of view."},
    ...
    {"diffuse", "(v.) to scatter, thin out, break up", "He diffused the tension in the room by making in a joke."},
    {"diffuse", "(adj.) not concentrated, scattered, disorganized", "In her writings, she tried unsuccessfully to make others understand her diffuse thoughts. "},
    ...
    {"disdain", "(v.) to scorn, hold in low esteem", "Insecure about their jobs, the older employees disdained the recently hired ones, who were young and capable."},
    {"disdain", "(n.) scorn, low esteem", "After learning of his immoral actions, Justine held Lawrence in disdain."},
    ...
    {"disrepute", "(n.) a state of being held in low regard", "The officer fell into disrepute after it was learned that he had disobeyed the orders he had given to his own soldiers."},
    ...
    {"dissent", "(v.) to disagree", "The principal argued that the child should repeat the fourth grade, but the unhappy parents dissented."},
    {"dissent", "(n.) the act of disagreeing", "Unconvinced that the defendant was guilty, the last juror voiced his dissent with the rest of the jury."},
    {"dissipate", "(v.) to disappear, cause to disappear", "The sun finally came out and dissipated the haze."},
    {"dissipate", "(v.) to waste", "She dissipated her fortune on a series of bad investments."},
    ...
    {"dogmatic", "(adj.) aggressively and arrogantly certain about unproved principles", "His dogmatic claim that men were better than women at fixing appliances angered everyone."},
    ...
    {"dynamic", "(adj.) actively changing", "The parents found it hard to keep up with the dynamic music scene with which their children had become very familiar."},
    ...
    {"ecstatic", "(adj.) intensely and overpoweringly happy", "The couple was ecstatic when they learned that they had won the lottery."},
    ...
    {"elaborate", "(adj.) complex, detailed, intricate", "Dan always beats me at chess because he develops such an elaborate game plan that I can never predict his next move."},
    ...
    {"elicit", "(v.) to bring forth, draw out, evoke", "Although I asked several times where the exit was, I elicited no response from the stone-faced policeman."},
    {"eloquent", "(adj.) expressive, articulate, moving", "The priest gave such an eloquent sermon that most churchgoers were crying."},
    ...
    {"embellish", "(v.) to decorate, adorn", "My mom embellished the living room by adding lace curtains."},
    {"embellish", "(v.) to add details to, enhance", "When Harry told me that he had “done stuff” on his vacation, I asked him to embellish upon his account. "},
    ...
    {"eminent", "(adj.) distinguished, prominent, famous", "Mr. Phillips is such an eminent scholar that every professor on campus has come to hear him lecture."},
    {"eminent", "(adj.) conspicuous", "There is an eminent stain on that shirt."},
    ...
    {"empirical", "(adj.) based on observation or experience", "The scientist gathered empirical data on the growth rate of dandelions by studying the dandelions behind his house."},
    {"empirical", "(adj.) capable of being proved or disproved by experiment", "That all cats hate getting wet is an empirical statement: I can test it by bathing my cat, Trinket."},
    ...
    {"enamor", "(v.) to fill with love, fascinate, usually used in passive form followed by “of” or “with”", "I grew enamored of that boy when he quoted my favorite love poem."},
    ...
    {"enfranchise", "(v.) to grant the vote to", "The Nineteenth Amendment enfranchised women."},
    ...
    {"entail", "(v.) to include as a necessary step", "Building a new fence entails tearing down the old one."},
    ...
    {"epitome", "(n.) a perfect example, embodiment", "My mother, the epitome of good taste, always dresses more elegantly than I do."},
    ...
    {"ethereal", "(adj.) heavenly, exceptionally delicate or refined", "In her flowing silk gown and lace veil, the bride looked ethereal."},
    {"etymology", "(n.) the history of words, their origin and development", "From the study of etymology, I know that the word “quixotic” derives from Don Quixote and the word “gaudy” refers to the Spanish architect Gaudí."},
    {"euphoric", "(adj.) elated, uplifted", "I was euphoric when I found out that my sister had given birth to twins."},
    ...
    {"façade", "(n.) the wall of a building", "Meet me in front of the museum's main façade."},
    {"façade", "(n.) a deceptive appearance or attitude", "Despite my smiling façade, I am feeling melancholy."},
    {"facile", "(adj.) easy, requiring little effort", "This game is so facile that even a four-yearold can master it."},
    {"facile", "(adj.) superficial, achieved with minimal thought or care, insincere", "The business was in such shambles that any solution seemed facile at best; nothing could really helpit in the long-run."},
    ...
    {"felicitous", "(adj.) well suited, apt", "While his comments were idiotic and rambling, mine were felicitous and helpful."},
    {"felicitous", "(adj.) delightful, pleasing", "I spent a felicitous afternoon visiting old friends."},
    ...
    {"forbearance", "(n.) patience, restraint, toleration", "The doctor showed great forbearance in calming down the angry patient who shouted insults at him."},
    ...
    {"forsake", "(v.) to give up, renounce", "My New Year's resolution is to forsake smoking and drinking."},
    {"fortitude", "(n.) strength, guts", "Achilles' fortitude in battle is legendary."},
    {"fortuitous", "(adj.) happening by chance, often lucky or fortunate", "After looking for Manuel and not finding him at home, Harriet had a fortuitous encounter with him at the post office."},
    {"forum", "(n.) a medium for lecture or discussion", "Some radio talk-shows provide a good forum for political debate."},
    {"foster", "(v.) to stimulate, promote, encourage", "To foster good health in the city, the mayor started a “Get out and exercise!” campaign."},
    ...
    {"fraught", "(adj.) filled or accompanied with", "Her glances in his direction were fraught with meaning, though precisely what meaning remained unclear."},
    ...
    {"frugal", "(adj.) thrifty, economical", "Richard is so frugal that his diet consists almost exclusively of catfish and chicken liver—the two most inexpensive foods in the store."},
    ...
    {"garish", "(adj.) gaudy, in bad taste", "Mrs. Watson has poor taste and covers every object in her house with a garish gold lamé."},
    {"garrulous", "(adj.) talkative, wordy", "Some talk show hosts are so garrulous that their guests can't get a word in edgewise."},
    {"genial", "(adj.) friendly, affable", "Although he's been known to behave like a real jerk, I would say that my brother is an overall genial guy."},
    {"gluttony", "(n.) overindulgence in food or drink", "Ada's fried chicken tastes so divine, I don't know how anyone can call gluttony a sin."},
    ...
    {"gourmand", "(n.) someone fond of eating and drinking", "My parents, who used to eat little more than crackers and salad, have become real gourmands in their old age."},
    ...
    {"grandiose", "(adj.) on a magnificent or exaggerated scale", "Margaret planned a grandiose party, replete with elephants, trapeze artists, and clowns."},
    ...
    {"harangue", "(n.) a ranting speech", "Everyone had heard the teacher's harangue about gum chewing in class before."},
    {"harangue", "(v.) to give such a speech", "But this time the teacher harangued the class about the importance of brushing your teeth after chewing gum."},
    ...
    {"heinous", "(adj.) shockingly wicked, repugnant", "The killings were made all the more heinous by the fact that the murderer first tortured his victims for three days."},
    {"heterogeneous", "(adj.) varied, diverse in character", "I hate having only one flavor so I always buy the swirled, or should I say heterogeneous, type of ice cream."},
    {"hiatus", "(n.) a break or gap in duration or continuity", "The hiatus in service should last two or three months—until the cable lines are repaired ."},
    ...
    {"immerse", "(v.) to absorb, deeply involve, engross", "After breaking up with her boyfriend, Nancy decided to immerse herself in her work in order to avoid crying."},
    ...
    {"impeccable", "(adj.) exemplary, flawless", "If your grades were as impeccable as your sister's, then you too would receive a car for a graduation present."},
    {"impecunious", "(adj.) poor", "“I fear he's too impecunious to take me out tonight,” the bratty girl whined."},
    {"imperative", "(adj.) necessary, pressing", "It is imperative that you have these folders organized by midday."},
    {"imperative", "(n.) a rule, command, or order", "Her imperative to have the folders organized by midday was perceived as ridiculous by the others."},
    ...
    {"impinge", "(v.) to impact, affect, make an impression", "The hail impinged the roof, leaving large dents."},
    {"impinge", "(v.) to encroach, infringe", "I apologize for impinging upon you like this, but I really need to use your bathroom. Now."},
    ...
    {"implement", "(n.) an instrument, utensil, tool", "Do you have a knife or some other sort of implement that I could use to pry the lid off of this jar?"},
    {"implement", "(v.) to put into effect, to institute", "After the first town curfew failed to stop the graffiti problem, the mayor implemented a new policy to use security cameras to catch perpetrators in the act."},
    {"implicate", "(v.) to involve in an incriminating way, incriminate", "Even though Tom wasn't present at the time of the shooting, he was implicated by the evidence suggesting that he had supplied the shooters with guns."},
    {"implicit", "(adj.) understood but not outwardly obvious, implied", "I know Professor Smith didn't actually say not to write from personal experience, but I think such a message was implicit in her instruction to use scholarly sources."},
    ...
    {"inarticulate", "(adj.) incapable of expressing oneself clearly through speech", "Though he spoke for over an hour, the lecturer was completely inarticulate and the students had no idea what he was talking about."},
    {"incarnate", "(adj.) existing in the flesh, embodied", "In the church pageant, I play the role of greed incarnate."},
    {"incarnate", "(v.) to give human form to", "The alien evaded detection by incarnating himself in a human form."},
    {"incendiary", "(n.) a person who agitates", "If we catch the incendiary who screamed “bomb” in the middle of the soccer match, we're going to put him in jail."},
    {"incendiary", "(adj.) inflammatory, causing combustion", "Gas and lighter fluid are incendiary materials that should be kept out of hot storage areas."},
    {"incessant", "(adj.) unending", "We wanted to go outside and play, but the incessantrain kept us indoors for two days."},
    ...
    {"inclination", "(n.) a tendency, propensity", "Sarah has an inclination to see every foreign film she hears about, even when she's sure that she won't like it."},
    ...
    {"incumbent", "(n.) one who holds an office", "The incumbent senator is already serving his fifth term."},
    {"incumbent", "(adj.) obligatory", "It is incumbent upon this organization to offer aid to all who seek it."},
    ...
    {"indigenous", "(adj.) originating in a region", "Some fear that these plants, which are not indigenous to the region, may choke out the vegetation that is native to the area."},
    {"indigent", "(adj.) very poor, impoverished", "I would rather donate money to help the indigent population than to the park sculpture fund."},
    ...
    {"induce", "(v.) to bring about, stimulate", "Who knew that our decision to boycott school lunch would induce a huge riot?"},
    ...
    {"inept", "(adj.) not suitable or capable, unqualified", "She proved how inept she was when she forgot three orders and spilled a beer in a customer's lap."},
    ...
    {"infamy", "(n.) notoriety, extreme ill repute", "The infamy of his crime will not lessen as the decades pass."},
    ...
    {"innovate", "(v.) to do something in an unprecedented way", "Because of the stiff competition, the company knew it needed to pour a lot of energy into innovating new and better products."},
    ...
    {"insatiable", "(adj.) incapable of being satisfied", "My insatiable appetite for melons can be a real problem in the winter."},
    ...
    {"insinuate", "(v.) to suggest indirectly or subtly", "I wish Luke and Spencer would stop insinuating that my perfect report card is the result of anything other than my superior intelligence and good work habits."},
    ...
    {"instigate", "(v.) to urge, goad", "The demagogue instigated the crowd into a fury by telling them that they had been cheated by the federal government."},
    ...
    {"interject", "(v.) to insert between other things", "During our conversation, the cab driver occasionally interjected his opinion."},
    ...
    {"inviolable", "(adj.) secure from assault", "Nobody was ever able to break into Batman's inviolable Batcave."},
    ...
    {"irrevocable", "(adj.) incapable of being taken back", "The Bill of Rights is an irrevocable part of American law."},
    ...
    {"kudos", "(n.) praise for an achievement", "After the performance, the reviewers gave the opera singer kudos for a job well done."},
    {"laceration", "(n.) a cut, tear", "Because he fell off his bike into a rosebush, the paperboy's skin was covered with lacerations."},
    ...
    {"lavish", "(adj.) given without limits", "Because they had worked very hard, the performers appreciated the critic's lavish praise."},
    {"lavish", "(v.) to give without limits", "Because the performers had worked hard, they deserved the praise that the critic lavished on them."},
    ...
    {"lenient", "(adj.) demonstrating tolerance or gentleness", "Because Professor Oglethorpe allowed his students to choose their final grades, the other teachers believed that he was excessively lenient."},
    {"lethargic", "(adj.) in a state of sluggishness or apathy", "When Jean Claude explained to his boss that he was lethargic and didn't feel like working that day, the boss fired him."},
    {"liability", "(n.) something for which one is legally responsible, usually involving a disadvantage or risk", "The bungee-jumping tower was a great liability for the owners of the carnival."},
    {"liability", "(n.) a handicap, burden", "Because she often lost her concentration and didn't play defense, Marcy was a liability to the team."},
    {"libertarian", "(adj.) advocating principles of liberty and free will", "The dissatisfied subjects overthrew the monarch and replaced him with a libertarian ruler who respected their democratic principles."},
    ...
    {"lucid", "(adj.) clear, easily understandable", "Because Guenevere's essay was so lucid, I only had to read it once to understand her reasoning."},
    {"luminous", "(adj.) brightly shining", "The light of the luminous moon graced the shoulders of the beautiful maiden."},
    ...
    {"manifest", "(adj.) easily understandable, obvious", "When I wrote the wrong sum on the chalkboard, my mistake was so manifest that the entire class burst into laughter."},
    {"manifest", "(v.) to show plainly", "His illness first manifested itself with particularly violent hiccups."},
    ...
    {"medley", "(n.) a mixture of differing things", "Susannah's wardrobe contained an astonishing medley of colors, from olive green to fluorescent pink."},
    {"mendacious", "(adj.) having a lying, false character", "The mendaciouscontent of the tabloid magazines is at least entertaining."},
    ...
    {"metamorphosis", "(n.) the change of form, shape, substance", "Winnifred went to the gym every day for a year and underwent a metamorphosis from a waiflike girl to an athletic woman."},
    ...
    {"mitigate", "(v.) to make less violent, alleviate", "When I had an awful sore throat, only warm tea would mitigate the pain."},
    {"moderate", "(adj.) not extreme", "Luckily, the restaurant we chose had moderate prices; none of us have any money."},
    {"moderate", "(n.) one who expresses moderate opinions", "Because he found both the liberal and conservative proposals too excessive, Mr. Park sided with the moderates."},
    ...
    {"negligent", "(adj.) habitually careless, neglectful", "Jessie's grandfather called me a negligent fool after I left the door to his apartment unlocked even though there had been a recent string of robberies. "},
    {"neophyte", "(n.) someone who is young or inexperienced", "As a neophyte in the literary world, Malik had trouble finding a publisher for his first novel."},
    {"nocturnal", "(adj.) relating to or occurring during the night", "Jackie was a nocturnal person; she would study until dawn and sleep until the evening."},
    ...
    {"nomadic", "(adj.) wandering from place to place", "In the first six months after college, Jose led a nomadic life, living in New York, California, and Idaho."},
    ...
    {"nonchalant", "(adj.) having a lack of concern, indifference", "Although deep down she was very angry, Marsha acted in a nonchalant manner when she found out that her best friend had used her clothing without asking."},
    ...
    {"notorious", "(adj.) widely and unfavorably known", "Jacob was notorious for always arriving late at parties."},
    {"novice", "(n.) a beginner, someone without training or experience", "Because we were all novices at yoga, our instructor decided to begin with the basics."},
    ...
    {"nurture", "(v.) to assist the development of", "Although Serena had never watered the plant, which was about to die, Javier was able to nurture it back to life."},
    ...
    {"ornate", "(adj.) highly elaborate, excessively decorated", "The ornate styling of the new model of luxury car could not compensate for the poor quality of its motor."},
    {"orthodox", "(adj.) conventional, conforming to established protocol", "The company's profits dwindled because the management pursued orthodox business policies that were incompatible with new industrial trends."},
    ...
    {"permeate", "(v.) to spread throughout, saturate", "Mrs. Huxtable was annoyed that the wet dog's odor had permeated the furniture's upholstery."},
    ...
    {"perplex", "(v.) to confuse", "Brad was perplexed by his girlfriend's suddenly distant manner."},
    ...
    {"philanthropic", "(adj.) charitable, giving", "Many people felt that the billionaire's decision to donate her fortune to house the homeless was the ultimate philanthropic act."},
    ...
    {"platitude", "(n.) an uninspired remark, cliché", "After reading over her paper, Helene concluded that what she thought were profound insights were actually just platitudes."},
    ...
    {"prescribe", "(v.) to lay down a rule", "The duke prescribed that from this point further all of the peasants living on his lands would have to pay higher taxes."},
    ...
    {"procure", "(v.) to obtain, acquire", "The FBI was unable to procure sufficient evidence to charge the gangster with racketeering."},
    ...
    {"pungent", "(adj.) having a pointed, sharp quality—often used to describe smells", "The pungent odor in the classroom made Joseph lose his concentration during the test."},
    ...
    {"quaint", "(adj.) charmingly old-fashioned", "Hilda was delighted by the quaint bonnets she saw in Amish country."},
    ...
    {"reciprocate", "(v.) to give in return", "When Steve gave Samantha a sweater for Christmas, she reciprocated by giving him a kiss."},
    ...
    {"reconcile", "(v.) to return to harmony", "The feuding neighbors finally reconciled when one brought the other a delicious tuna noodle casserole."},
    {"reconcile", "(v.) to make consistent with existing ideas", "Alou had to reconcile his skepticism about the existence of aliens with the fact that he was looking at a flying saucer."},
    {"rectitude", "(n.) uprightness, extreme morality", "The priest's rectitude gave him the moral authority to counsel his parishioners."},
    {"redoubtable", "(adj.) formidable", "The fortress looked redoubtable set against a stormy sky."},
    {"redoubtable", "(adj.) commanding respect", "The audience greeted the redoubtable speaker with a standing ovation."},
    {"refract", "(v.) to distort, change", "The light was refracted as it passed through the prism."},
    {"refurbish", "(v.) to restore, clean up", "The dingy old chair, after being refurbished, commanded the handsome price of $200."},
    {"refute", "(v.) to prove wrong", "Maria refuted the president's argument as she yelled and gesticulated at the TV."},
    {"regurgitate", "(v.) to vomit", "Feeling sick, Chuck regurgitated his dinner."},
    {"regurgitate", "(v.) to throw back exactly", "Margaret rushed through the test, regurgitating all of the facts she'd memorized an hour earlier."},
    {"relegate", "(v.) to assign to the proper place", "At the astrology conference, Simon was relegated to the Scorpio room."},
    {"relegate", "(v.) to assign to an inferior place", "After spilling a drink on a customer's shirt, the waiter found himself relegated to the least lucrative shift."},
    ...
    {"renovate", "(v.) restore, return to original state", "The renovated antique candelabra looked as good as new."},
    {"renovate", "(v.) to enlarge and make prettier, especially a house", "After getting renovated, the house was twice as big and much more attractive."},
    {"renown", "(n.) honor, acclaim", "The young writer earned international renown by winning the Pulitzer Prize."},
    ...
    {"repulse", "(v.) to disgust", "Antisocial Annie tried to repulse people by neglecting to brush her teeth."},
    {"repulse", "(v.) to push back", "With a deft movement of her wrist and a punch to the stomach, Lacy repulsed Jack's attempt to kiss her."},
    {"reputable", "(adj.) of good reputation", "After the most reputable critic in the industry gave the novel a glowing review, sales took off."},
    ...
    {"reservoir", "(n.) reserves, large supply", "Igor the Indomitable had quite a reservoir of strengh and could lift ten tons, even after running 700 miles, jumping over three mountains, and swimming across an ocean."},
    {"reservoir", "(n.) a body of water used for storing water", "After graduation, the more rebellious members of the senior class jumped into the town reservoir used for drinking water."},
    {"resilient", "(adj.) able to recover from misfortune; able to withstand adversity", "The resilient ballplayer quickly recovered from his wrist injury."},
    ...
    {"resolve", "(v.) to find a solution", "Sarah and Emma resolved their differences and shook hands."},
    {"resolve", "(v.) to firmly decide", "Lady Macbeth resolved to whip her husband into shape."},
    ...
    {"retract", "(v.) withdraw", "As the media worked itself into a frenzy, the publicist hurriedly retracted his client's sexist statement."},
    {"revel", "(v.) to enjoy intensely", "Theodore reveled in his new status as Big Man on Campus."},
    {"revere", "(v.) to esteem, show deference, venerate", "The doctor saved countless lives with his combination of expertise and kindness and became universally revered."},
    {"revoke", "(v.) to take back", "After missing the curfew set by the court for eight nights in a row, Marcel's freedom of movement was revoked."},
    ...
    {"scrupulous", "(adj.) painstaking, careful", "With scrupulouscare, Sam cut a snowflake out of white paper."},
    ...
    {"solvent", "(n.) a substance that can dissolve other substances", "Water is sometimes called the universal solvent because almost all other substances can dissolve into it."},
    {"solvent", "(adj.) able to pay debts", "Upon receiving an unexpected check from her aunt, Annabelle found herself suddenly solvent."},
    ...
    {"validate", "(v.) to confirm, support, corroborate", "Yoko's chemistry lab partner was asleep during the experiment and could not validate the accuracy of her methods."},
    ...
    {"vigilant", "(adj.) watchful, alert", "The guards remained vigilant throughout the night, but the enemy never launched the expected attack."},
